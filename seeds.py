...
for image in onlyfiles:
    ...
    f.write(image + "\n")
    f.write("blue:"+str(calcPercentage(blueDilatedMaskSeedsGroup))+"%,")
    f.write("green:"+str(calcPercentage(greenDilatedMaskSeedsGroup))+"%,")
    f.write("yellow:"+str(calcPercentage(yellowDilatedMaskSeedsGroup))+"%\n\n")
